...
public class PokemonApplication {
	...
	public static void main(String[] args) {
		...
		if (System.getenv("GOOGLE_APPLICATION_CREDENTIALS") == null) {
			System.out.println(
					"Environment variable GOOGLE_APPLICATION_CREDENTIALS is null. It needs to equal the location of your google translation API key. The system can work without it, but you can not update the translations.");
